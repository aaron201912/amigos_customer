...
MODULE_REL_BIN += $(DB_3PARTY_PATH)/dnsmasq/bin/$(TOOLCHAIN_VERSION)/dnsmasq
MODULE_REL_BIN += $(DB_3PARTY_PATH)/hostapd/bin/$(TOOLCHAIN_VERSION)/hostapd
MODULE_REL_BIN += $(DB_3PARTY_PATH)/hostapd/bin/$(TOOLCHAIN_VERSION)/hostapd_cli
